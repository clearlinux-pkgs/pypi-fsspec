...
Source0  : https://files.pythonhosted.org/packages/19/4b/c755522aed160cbe69dc6c1f9e1641d39947e2ba3d6994c2e19b446b5594/fsspec-2022.8.2.tar.gz
...
%prep
%setup -q -n fsspec-2022.8.2
cd %{_builddir}/fsspec-2022.8.2
pushd ..
cp -a fsspec-2022.8.2 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1662049054
