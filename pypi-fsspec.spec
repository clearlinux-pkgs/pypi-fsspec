...
Source0  : https://files.pythonhosted.org/packages/90/b6/eba5024a9889fcfff396db543a34bef0ab9d002278f163129f9f01005960/fsspec-2024.6.1.tar.gz
...
%prep
%setup -q -n fsspec-2024.6.1
cd %{_builddir}/fsspec-2024.6.1
pushd ..
cp -a fsspec-2024.6.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1719522124
