...
Source0  : https://files.pythonhosted.org/packages/f2/77/deb99b97981e2e191913454da82d406702405178631c31cd623caebaf1b1/fsspec-2025.5.0.tar.gz
...
%prep
%setup -q -n fsspec-2025.5.0
cd %{_builddir}/fsspec-2025.5.0
pushd ..
cp -a fsspec-2025.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1747762069
