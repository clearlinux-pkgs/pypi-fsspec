...
Source0  : https://files.pythonhosted.org/packages/34/f4/5721faf47b8c499e776bc34c6a8fc17efdf7fdef0b00f398128bc5dcb4ac/fsspec-2025.3.0.tar.gz
...
%prep
%setup -q -n fsspec-2025.3.0
cd %{_builddir}/fsspec-2025.3.0
pushd ..
cp -a fsspec-2025.3.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1742455820
