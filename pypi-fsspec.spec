...
Source0  : https://files.pythonhosted.org/packages/44/7c/fb753d18e2eeb186a47ecd6939326f7633a027fe23a44ee7912978e64819/fsspec-2022.11.0.tar.gz
...
%prep
%setup -q -n fsspec-2022.11.0
cd %{_builddir}/fsspec-2022.11.0
pushd ..
cp -a fsspec-2022.11.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1668096295
