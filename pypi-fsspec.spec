...
Source0  : https://files.pythonhosted.org/packages/8b/02/0835e6ab9cfc03916fe3f78c0956cfcdb6ff2669ffa6651065d5ebf7fc98/fsspec-2025.7.0.tar.gz
...
%prep
%setup -q -n fsspec-2025.7.0
cd %{_builddir}/fsspec-2025.7.0
pushd ..
cp -a fsspec-2025.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1752603058
