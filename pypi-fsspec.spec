...
Source0  : https://files.pythonhosted.org/packages/71/28/cbf337fddd6f22686b7c2639b80e006accd904db152fe333fd98f4cd8d1e/fsspec-2024.5.0.tar.gz
...
%prep
%setup -q -n fsspec-2024.5.0
cd %{_builddir}/fsspec-2024.5.0
pushd ..
cp -a fsspec-2024.5.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1715810860
