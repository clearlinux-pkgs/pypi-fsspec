...
Source0  : https://files.pythonhosted.org/packages/00/f7/27f15d41f0ed38e8fcc488584b57e902b331da7f7c6dcda53721b15838fc/fsspec-2025.5.1.tar.gz
...
%prep
%setup -q -n fsspec-2025.5.1
cd %{_builddir}/fsspec-2025.5.1
pushd ..
cp -a fsspec-2025.5.1 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1748370828
