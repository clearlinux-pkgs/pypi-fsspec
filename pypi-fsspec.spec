...
Source0  : https://files.pythonhosted.org/packages/a4/f7/16ec1f92523165d10301cfa8cb83df0356dbe615d4ca5ed611a16f53e09a/fsspec-2023.10.0.tar.gz
...
%prep
%setup -q -n fsspec-2023.10.0
cd %{_builddir}/fsspec-2023.10.0
pushd ..
cp -a fsspec-2023.10.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1698018938
