...
Source0  : https://files.pythonhosted.org/packages/79/a5/3be4f3b4e941ee4526dd52f9c0a4ae6660ccb92e59b553e794015b249e97/fsspec-2024.6.0.tar.gz
...
%prep
%setup -q -n fsspec-2024.6.0
cd %{_builddir}/fsspec-2024.6.0
pushd ..
cp -a fsspec-2024.6.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1717510804
