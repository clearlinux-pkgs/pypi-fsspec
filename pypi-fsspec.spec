...
Source0  : https://files.pythonhosted.org/packages/62/7c/12b0943011daaaa9c35c2a2e22e5eb929ac90002f08f1259d69aedad84de/fsspec-2024.9.0.tar.gz
...
%prep
%setup -q -n fsspec-2024.9.0
cd %{_builddir}/fsspec-2024.9.0
pushd ..
cp -a fsspec-2024.9.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1725548448
