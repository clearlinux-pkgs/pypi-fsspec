...
Source0  : https://files.pythonhosted.org/packages/f4/c5/6a340991becbd30bfc46efb83137aae492120946e8dcf3e6ac23350563a5/fsspec-2022.1.0.tar.gz
...
%prep
%setup -q -n fsspec-2022.1.0
cd %{_builddir}/fsspec-2022.1.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1641940098
...
cp %{_builddir}/fsspec-2022.1.0/LICENSE %{buildroot}/usr/share/package-licenses/pypi-fsspec/05ee6f4bb52a15a0a29b05ceab4c9648092a8c51
