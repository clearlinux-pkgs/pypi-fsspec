...
Version  : 2022.7.0
Release  : 25
URL      : https://files.pythonhosted.org/packages/41/17/0464c93848b909648540927f5202b34b71a06db2d42c10b33a932219040b/fsspec-2022.7.0.tar.gz
Source0  : https://files.pythonhosted.org/packages/41/17/0464c93848b909648540927f5202b34b71a06db2d42c10b33a932219040b/fsspec-2022.7.0.tar.gz
...
%prep
%setup -q -n fsspec-2022.7.0
cd %{_builddir}/fsspec-2022.7.0
pushd ..
cp -a fsspec-2022.7.0 buildavx2
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1659020593
